...
```bash
npx skills add aniruddhaadak80/skills --skill debug-craft-systematic-bug-hunt-kotlin
```

**Install globally**
```bash
npx skills add aniruddhaadak80/skills --skill debug-craft-systematic-bug-hunt-kotlin -g
```
