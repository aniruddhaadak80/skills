---
name: code-quality-code-review-checklist-node
description: "Review order, comment quality, and scope discipline making PRs fast and kind."
---
# Review code like a senior engineer (Node.js)
...
```bash
npx skills add aniruddhaadak80/skills --skill code-quality-code-review-checklist-node
```

**Install globally**
```bash
npx skills add aniruddhaadak80/skills --skill code-quality-code-review-checklist-node -g
```
