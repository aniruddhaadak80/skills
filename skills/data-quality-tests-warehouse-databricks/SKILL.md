---
name: data-quality-tests-warehouse-databricks
description: "Layered data quality tests that block bad data from reaching downstream consumers."
---
# Test warehouse data like software (Databricks/Delta)
...
7. Use Delta EXPECTATIONS for inline quality gates
8. Track table properties for freshness metadata
...
```bash
npx skills add aniruddhaadak80/skills --skill data-quality-tests-warehouse-databricks
```

**Install globally**
```bash
npx skills add aniruddhaadak80/skills --skill data-quality-tests-warehouse-databricks -g
```
