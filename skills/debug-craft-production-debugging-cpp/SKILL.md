...
7. Sanitizer builds (ASan/UBSan) in CI before perf tuning
8. Profile with perf/VTune; watch cache lines and allocations
...
```bash
npx skills add aniruddhaadak80/skills --skill debug-craft-production-debugging-cpp
```

**Install globally**
```bash
npx skills add aniruddhaadak80/skills --skill debug-craft-production-debugging-cpp -g
```
