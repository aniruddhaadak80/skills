...
```bash
npx skills add aniruddhaadak80/skills --skill code-quality-performance-profiling-elixir
```

**Install globally**
```bash
npx skills add aniruddhaadak80/skills --skill code-quality-performance-profiling-elixir -g
```
