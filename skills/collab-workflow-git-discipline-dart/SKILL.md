---
name: collab-workflow-git-discipline-dart
description: "Commit hygiene, branch strategy, and recovery skills preventing shared-repo disasters."
---
# Practice git discipline teams thank you for (Dart/Flutter)
...
```bash
npx skills add aniruddhaadak80/skills --skill collab-workflow-git-discipline-dart
```

**Install globally**
```bash
npx skills add aniruddhaadak80/skills --skill collab-workflow-git-discipline-dart -g
```
