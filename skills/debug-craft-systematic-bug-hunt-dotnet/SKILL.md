...
```bash
npx skills add aniruddhaadak80/skills --skill debug-craft-systematic-bug-hunt-dotnet
```

**Install globally**
```bash
npx skills add aniruddhaadak80/skills --skill debug-craft-systematic-bug-hunt-dotnet -g
```
