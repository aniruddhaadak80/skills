---
name: debug-craft-production-debugging-kotlin
description: "Safe live diagnosis using flags, traces, and snapshots instead of restart roulette."
---
# Debug production without stopping the world (Kotlin)
...
7. Leverage coroutines structured concurrency; cancel scopes deliberately
8. Watch Kotlin/Native memory model differences in multiplatform code
...
```bash
npx skills add aniruddhaadak80/skills --skill debug-craft-production-debugging-kotlin
```

**Install globally**
```bash
npx skills add aniruddhaadak80/skills --skill debug-craft-production-debugging-kotlin -g
```
