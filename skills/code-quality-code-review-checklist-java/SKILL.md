---
name: code-quality-code-review-checklist-java
description: "Review order, comment quality, and scope discipline making PRs fast and kind."
---
# Review code like a senior engineer (Java/JVM)
...
```bash
npx skills add aniruddhaadak80/skills --skill code-quality-code-review-checklist-java
```

**Install globally**
```bash
npx skills add aniruddhaadak80/skills --skill code-quality-code-review-checklist-java -g
```
