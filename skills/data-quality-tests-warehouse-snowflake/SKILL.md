...
7. Leverage streams/tasks for change-driven tests
8. Watch warehouse credits: schedule heavy tests off-peak
...
```bash
npx skills add aniruddhaadak80/skills --skill data-quality-tests-warehouse-snowflake
```

**Install globally**
```bash
npx skills add aniruddhaadak80/skills --skill data-quality-tests-warehouse-snowflake -g
```
