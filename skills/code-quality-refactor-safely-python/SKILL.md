...
```bash
npx skills add aniruddhaadak80/skills --skill code-quality-refactor-safely-python
```

**Install globally**
```bash
npx skills add aniruddhaadak80/skills --skill code-quality-refactor-safely-python -g
```
