...
7. Let the borrow checker guide design; resist RefCell escapes
8. Benchmark criterion suites for hot paths before optimizing
...
```bash
npx skills add aniruddhaadak80/skills --skill debug-craft-production-debugging-rust
```

**Install globally**
```bash
npx skills add aniruddhaadak80/skills --skill debug-craft-production-debugging-rust -g
```
