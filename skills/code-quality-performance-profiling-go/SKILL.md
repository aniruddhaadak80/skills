---
name: code-quality-performance-profiling-go
...
```bash
npx skills add aniruddhaadak80/skills --skill code-quality-performance-profiling-go
```

**Install globally**
```bash
npx skills add aniruddhaadak80/skills --skill code-quality-performance-profiling-go -g
```
