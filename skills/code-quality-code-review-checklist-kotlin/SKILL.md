---
name: code-quality-code-review-checklist-kotlin
description: "Review order, comment quality, and scope discipline making PRs fast and kind."
---
# Review code like a senior engineer (Kotlin)
...
```bash
npx skills add aniruddhaadak80/skills --skill code-quality-code-review-checklist-kotlin
```

**Install globally**
```bash
npx skills add aniruddhaadak80/skills --skill code-quality-code-review-checklist-kotlin -g
```
