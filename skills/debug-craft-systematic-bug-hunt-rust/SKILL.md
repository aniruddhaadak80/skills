...
```bash
npx skills add aniruddhaadak80/skills --skill debug-craft-systematic-bug-hunt-rust
```

**Install globally**
```bash
npx skills add aniruddhaadak80/skills --skill debug-craft-systematic-bug-hunt-rust -g
```
