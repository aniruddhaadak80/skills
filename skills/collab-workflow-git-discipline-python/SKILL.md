...
```bash
npx skills add aniruddhaadak80/skills --skill collab-workflow-git-discipline-python
```

**Install globally**
```bash
npx skills add aniruddhaadak80/skills --skill collab-workflow-git-discipline-python -g
```
