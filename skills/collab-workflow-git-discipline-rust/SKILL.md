...
```bash
npx skills add aniruddhaadak80/skills --skill collab-workflow-git-discipline-rust
```

**Install globally**
```bash
npx skills add aniruddhaadak80/skills --skill collab-workflow-git-discipline-rust -g
```
