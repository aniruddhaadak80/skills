...
7. Pick InnoDB with utf8mb4; watch index length limits
8. Beware implicit type coercion in joins
...
```bash
npx skills add aniruddhaadak80/skills --skill databases-schema-design-basics-mysql
```

**Install globally**
```bash
npx skills add aniruddhaadak80/skills --skill databases-schema-design-basics-mysql -g
```
