---
name: code-quality-performance-profiling-ruby
...
```bash
npx skills add aniruddhaadak80/skills --skill code-quality-performance-profiling-ruby
```

**Install globally**
```bash
npx skills add aniruddhaadak80/skills --skill code-quality-performance-profiling-ruby -g
```
