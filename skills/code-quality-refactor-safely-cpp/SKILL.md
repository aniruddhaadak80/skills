...
```bash
npx skills add aniruddhaadak80/skills --skill code-quality-refactor-safely-cpp
```

**Install globally**
```bash
npx skills add aniruddhaadak80/skills --skill code-quality-refactor-safely-cpp -g
```
