...
```bash
npx skills add aniruddhaadak80/skills --skill debug-craft-systematic-bug-hunt-elixir
```

**Install globally**
```bash
npx skills add aniruddhaadak80/skills --skill debug-craft-systematic-bug-hunt-elixir -g
```
