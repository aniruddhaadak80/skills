...
```bash
npx skills add aniruddhaadak80/skills --skill debug-craft-systematic-bug-hunt-java
```

**Install globally**
```bash
npx skills add aniruddhaadak80/skills --skill debug-craft-systematic-bug-hunt-java -g
```
