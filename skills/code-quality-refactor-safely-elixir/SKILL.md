...
```bash
npx skills add aniruddhaadak80/skills --skill code-quality-refactor-safely-elixir
```

**Install globally**
```bash
npx skills add aniruddhaadak80/skills --skill code-quality-refactor-safely-elixir -g
```
