...
```bash
npx skills add aniruddhaadak80/skills --skill collab-workflow-git-discipline-java
```

**Install globally**
```bash
npx skills add aniruddhaadak80/skills --skill collab-workflow-git-discipline-java -g
```
