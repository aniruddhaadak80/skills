...
```bash
npx skills add aniruddhaadak80/skills --skill code-quality-refactor-safely-rust
```

**Install globally**
```bash
npx skills add aniruddhaadak80/skills --skill code-quality-refactor-safely-rust -g
```
