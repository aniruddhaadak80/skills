...
```bash
npx skills add aniruddhaadak80/skills --skill code-quality-refactor-safely-scala
```

**Install globally**
```bash
npx skills add aniruddhaadak80/skills --skill code-quality-refactor-safely-scala -g
```
