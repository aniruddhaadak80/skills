...
```bash
npx skills add aniruddhaadak80/skills --skill debug-craft-systematic-bug-hunt-cpp
```

**Install globally**
```bash
npx skills add aniruddhaadak80/skills --skill debug-craft-systematic-bug-hunt-cpp -g
```
