...
```bash
npx skills add aniruddhaadak80/skills --skill collab-workflow-git-discipline-dotnet
```

**Install globally**
```bash
npx skills add aniruddhaadak80/skills --skill collab-workflow-git-discipline-dotnet -g
```
