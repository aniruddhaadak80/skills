...
```bash
npx skills add aniruddhaadak80/skills --skill debug-craft-production-debugging-php
```

**Install globally**
```bash
npx skills add aniruddhaadak80/skills --skill debug-craft-production-debugging-php -g
```
