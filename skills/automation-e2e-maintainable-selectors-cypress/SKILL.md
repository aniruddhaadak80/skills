...
7. Avoid conditional control-flow; command determinism wins
8. Intercept network for deterministic state setup
...
```bash
npx skills add aniruddhaadak80/skills --skill automation-e2e-maintainable-selectors-cypress
```

**Install globally**
```bash
npx skills add aniruddhaadak80/skills --skill automation-e2e-maintainable-selectors-cypress -g
```
