...
7. Model around access patterns: embed what reads together
8. Validate with JSON Schema at the driver level
...
```bash
npx skills add aniruddhaadak80/skills --skill databases-schema-design-basics-mongodb
```

**Install globally**
```bash
npx skills add aniruddhaadak80/skills --skill databases-schema-design-basics-mongodb -g
```
