...
```bash
npx skills add aniruddhaadak80/skills --skill debug-craft-systematic-bug-hunt-scala
```

**Install globally**
```bash
npx skills add aniruddhaadak80/skills --skill debug-craft-systematic-bug-hunt-scala -g
```
